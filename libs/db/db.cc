...
void clean_sessions(){
  ...
  PGresult *res = execute_or_die("update sessions set state_id = 3 , time_end = current_timestamp(6) where state_id = 1 and time_last < current_timestamp(6) - interval '5  minutes' returning id ;",PGRES_TUPLES_OK);
